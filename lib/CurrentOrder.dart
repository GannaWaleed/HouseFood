...
class currentOrdersPage extends StatefulWidget {
  ...
  const currentOrdersPage({Key? key, required this.userId}) : super(key: key);

  @override
  _OrderPageState createState() => _OrderPageState();
}

class _OrderPageState extends State<currentOrdersPage> {
  List<dynamic> orders = [];
  ...
  Future<void> fetchOrders() async {
    final response = await http.get(
        Uri.parse('http://192.168.1.4:3000/orders/${widget.userId}/accepted'));
        ...
        child: ListView.builder(
          ...
          itemBuilder: (context, index) {
            ...
            return FutureBuilder(
              future: fetchUserDetails(order['chefId']),
              builder:
