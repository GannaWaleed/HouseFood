...
class _AddFoodState extends State<AddFood> {
  ...
  void addFood(
    ...
    final url = Uri.parse('http://192.168.1.2:3000/food-items');
  ...
  void editFood(
    ...
    print(foodList);
    final url = Uri.parse(
        'http://192.168.1.2:3000/food-items/$id'); // Use the received id
  ...
  void deleteFoodItem(String? id) async {
    ...
    if (deleteConfirmed != null && deleteConfirmed) {
      final url = Uri.parse('http://192.168.1.2:3000/food-items/$id');
...
void initState() {
  ...
  final url = Uri.parse('http://192.168.1.2:3000/food-items?chefId=$chefId');
