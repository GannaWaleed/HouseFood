...
class ProcessingOrdersPage extends StatefulWidget {
  ...
  const ProcessingOrdersPage({Key? key, required this.chefId})
      : super(key: key);
...
class _OrderPageState extends State<ProcessingOrdersPage> {
  List<dynamic> orders = [];
  ...
  Future<void> fetchOrders() async {
    final response = await http.get(Uri.parse(
        'http://192.168.1.4:3000/orders/${widget.chefId}/processing'));
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            ElevatedButton(
                              ...
                              onPressed: () => finishOrder(order['_id']),
                              child: Text('Finished'),
                            ),
                          ],
                        ),
