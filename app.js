      ...
      ////////////////////////////////  API to delete account
        app.delete('/profile/:id', async (req, res) => {
          ...
          try {
            ...
            if (deletedUser.isHomeMaker === true) {
              // If the user is a chef, delete their associated food items
              await FoodItem.deleteMany({ chefId: userId });
              await CartItem.deleteMany({userId: deletedUser._id});
              res.send('Chef account and associated food items deleted successfully');
            } else {
