      ...
      body: SingleChildScrollView(
        child: Padding(
          padding: const EdgeInsets.only(
              top: 140.0, bottom: 200.00, left: 16.0, right: 16.0),
          child: Column(
...
validator: (value) {
  ...
  if (!RegExp(r'@(gmail\.com|yahoo\.com|microsoft\.com|hotmail\.com)$').hasMatch(value)) {
    return 'Email must end with @gmail.com, @yahoo.com, @microsoft.com, or @hotmail.com';
  }
  return null;
},
                ),
  ...
  Future<bool> checkCredentials(String email, String password) async {
    ...
    final response = await http.post(
      ...
      if (response.statusCode == 200) {
        ...
        final responseData = json.decode(response.body); // body received from an HTTP response
        final userId = responseData['userId']; //
