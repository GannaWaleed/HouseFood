...
class _AddFoodState extends State<AddFood> {
              ...
              children: [
                ...
                Expanded(
                  ...
                  child: IconButton(
                    ...
                    onPressed: () {
                      showEditFoodDialog(index, widget.userId);
                    },
                  ),
                ),
                Expanded(
                  ...
                  child: IconButton(
                    ...
                    onPressed: () {
                      if (foodList[index]['id'] != null) {
                        deleteFoodItem(foodList[index]['id']);
                      } else {
                        // Handle the case where id is null
                        ScaffoldMessenger.of(context).showSnackBar(
                          SnackBar(
                            content: Text('Error: Food id is null'),
  ...
  void addFood(
    ...
    final url = Uri.parse('http://192.168.1.7:3000/food-items');
  ...
  void showEditFoodDialog(int index, String userId) {
    TextEditingController foodNameController =
  ...
  void editFood(
    ...
    if (id != null) {
      ...
      final url = Uri.parse('http://192.168.1.7:3000/food-items/$id');
 ...
 void deleteFoodItem(String id) async {
  if (id != null) {
    ...
    if (response.statusCode == 200) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text('Error in deleting'),
          backgroundColor: Color.fromARGB(255, 245, 3, 3),
        ),
      );
    }
  ...
  void fetchFoodItems(String userId) async {
    final url = Uri.parse('http://192.168.1.7:3000/food-items?userId=$userId');
